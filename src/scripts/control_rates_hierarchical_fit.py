...
with open(paths.rates_vectors_bbh, 'rb') as f:
...
df_sel_vec = pd.read_hdf(paths.rates_vectors_sel, "selection")
with h5py.File(paths.rates_vectors_sel) as f:
