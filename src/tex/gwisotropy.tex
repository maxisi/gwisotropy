...
We apply the above procedure starting from a collection of \Nevents isotropized events obtained by randomizing each of the \Nevents in our dataset once, as described above; we then progressively double the size of this synthetic catalog five times, with as many randomizations of our initial set as needed.
We show the result for $\dip{J}$ in Fig.~XX.

\begin{figure}
\includegraphics[width=\columnwidth]{figures/control_isotropized.pdf}
\caption{\emph{Control}.
}
\label{fig:isotropized}
